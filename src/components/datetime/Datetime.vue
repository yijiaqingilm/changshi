    ...
    computed: {
      inputValue () {
        ...
        if (typeof format === 'string') {
          let value = this.datetime ? DateTime.fromISO(this.datetime).setZone(this.zone).toFormat(format) : ''
          this.$emit('update:displayValue', value)
          return value
        } else {
          let value = this.datetime ? this.datetime.setZone(this.zone).toLocaleString(format) : ''
          this.$emit('update:displayValue', value)
          return value
        }
      },
